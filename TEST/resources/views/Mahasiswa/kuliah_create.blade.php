                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="nomor_pc" required>
                                              <option value="" disabled selected>Nomor PC</option>
                                              <script>
                                                for (let i = 1; i <= 40; i++) {
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="nomor_pc" required>
                                                <option value="" disabled selected>Nomor Loker</option>
                                                <script>
                                                    for (let i = 1; i <= 40; i++) {
                                                    document.write(`<option value="${i}">${i}</option>`);
                                                    }
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="ruang_lab" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                ...
                                                <input type="radio" class="form-check-input" name="monitor" value="Bagus" required>Bagus
                                            </label>
                                            <label class="form-check form-check-inline">
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="alat" rows="5" required></textarea>
                                          </div>
                                    </div>
                                </div>
