    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="align-items-center d-flex m-0 navbar-brand text-wrap"
                href="https://soft-ui-dashboard-laravel.creative-tim.com/dashboard">
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link " href="https://soft-ui-dashboard-laravel.creative-tim.com/dashboard">
                        <div
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="https://soft-ui-dashboard-laravel.creative-tim.com/user-profile">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link active"
                        href="https://soft-ui-dashboard-laravel.creative-tim.com/user-management">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark text-white "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="https://soft-ui-dashboard-laravel.creative-tim.com/tables">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="https://soft-ui-dashboard-laravel.creative-tim.com/rtl">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="https://soft-ui-dashboard-laravel.creative-tim.com/profile">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="https://soft-ui-dashboard-laravel.creative-tim.com/static-sign-in">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="https://soft-ui-dashboard-laravel.creative-tim.com/static-sign-up">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active text-capitalize" aria-current="page">user
                            management</li>
                    </ol>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0"><a
                                                            ...
                                                            data-cfemail="5f3e3b3236311f2c30392b2a36713c3032">[email&#160;protected]</a>
                                                    </p>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Admin</p>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">16/06/18</span>
                                                </td>
                                                <td class="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0"><a
                                                            href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                            data-cfemail="c6a5b4a3a7b2a9b486b5a9a0b2b3afe8a5a9ab">[email&#160;protected]</a>
                                                    </p>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Creator</p>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">05/05/20</span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit user">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0"><a
                                                            href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                            data-cfemail="5e333b333c3b2c1e2d31382a2b37703d3133">[email&#160;protected]</a>
                                                    </p>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Member</p>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">23/06/20</span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit user">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0"><a
                                                            href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                            data-cfemail="e59580918097968a8ba5968a8391908ccb868a88">[email&#160;protected]</a>
                                                    </p>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Member</p>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">26/10/17</span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit user">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0"><a
                                                            href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                            data-cfemail="7e131f0c171b3e0d11180a0b17501d1113">[email&#160;protected]</a>
                                                    </p>
                                                </td>
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Creator</p>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">23/01/21</span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit user">
