            ...
            <div>
                <div class="alert alert-secondary mx-4" role="alert">
                    <span class="text-white">
                        <strong>
                            <center>SELAMAT DATANG DI CYBER HIVE, DIBAWAH INI ADALAH DESKRIPSI ANGOTTA KELOMPOK DAN PIC
                                NYA!!!</center>
                        </strong>
                    </span>
                </div>
                            ...
                            <div class="card-header pb-0">
                                <div class="d-flex flex-row justify-content-between">
                                    ...
                                    <a href="#" class="btn bg-gradient-primary btn-sm mb-0"
                                        type="button">+&nbsp; TAMBAH ANGGOTA SAYANG...</a>
                                </div>
                            </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">rezki23ti@mahasiswa.pcr.ac.id</p>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">PROJEK MANAJER DAN BACKEND DEVELOPER</span>
                                                </td>
                                                <td class="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">aqila23ti@mahasiswa.pcr.ac.id</p>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">PROJEK ANALIST</span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit user">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">helfia23ti@mahasiswa.pcr.ac.id</p>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">SISTWEM ANALIST</span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit user">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">abyaz23ti@mahasiswa.pcr.ac.id</p>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">FRONTEND DEVELOPER</span>
                                                </td>
                                                <td class="text-center">
                                                    <a href="#" class="mx-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit user">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">fadhel23ti@mahasiswa.pcr.ac.id</p>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">FRONTEND DEVELOPER</span>
                    ...
                    <div class="row align-items-center justify-content-lg-betendween">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                Sekian terimakasih atas kunjungannya. untuk lebih detail anda bisa klik aksi setiap data dari anggota
                            </div>
                        </div>
                    </div>
                </div>
